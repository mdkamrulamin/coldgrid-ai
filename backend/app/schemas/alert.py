...
class AlertResponse(BaseModel):
    ...
    id: int
    device_database_id: int = Field(alias="deviceDatabaseId") #Internal database device ID.
    ...
    device_uid: str | None = Field(default=None, alias="deviceUid") # Example: dev_7ca3ffaa48610fde
